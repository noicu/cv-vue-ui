...
`)]),default:t(()=>[l(c,{items:s.listItems2,hover:""},{item:t(({item:o})=>[i("div",K,[e(n(o.label),1),l(b,{md:"",onClick:a[0]||(a[0]=()=>s.listItems2.splice(s.index-1,1))},{default:t(()=>[e(n(o.icon),1)]),_:2},1024)])]),_:1},8,["items"])]),_:1}),l(m,{h2:""},{default:t(()=>[e("Selectable list items")]),_:1}),M,l(r,null,{pug:t(()=>[e(`w-radios.mb6(v-model="multiple" :items="radios" inline)
...
<div class="title3 mt2">
  ...
  selection: 2,
  itemClicked: null
})`)]),default:t(()=>[l(I,{class:"mb6",modelValue:s.multiple,"onUpdate:modelValue":a[1]||(a[1]=o=>s.multiple=o),items:s.radios,inline:""},null,8,["modelValue","items"]),l(w,{wrap:"","align-center":""},{default:t(()=>[l(c,{class:"grow mr4",modelValue:s.selection1,"onUpdate:modelValue":a[2]||(a[2]=o=>s.selection1=o),items:s.listItems1,color:"deep-purple",multiple:s.multiple,onItemClick:a[3]||(a[3]=o=>s.itemClicked=o)},null,8,["modelValue","items","multiple"]),s.itemClicked?(u(),p("div",O,[R,B,i("span",L,n(s.itemClicked),1)])):y("",!0)]),_:1}),i("div",Y,[e("Selected item:"),!s.multiple||Array.isArray(s.selection1)?(u(),p("code",q,n(s.selection1||"null"),1)):s.multiple?(u(),p("code",F,n(s.selection1?[s.selection1]:"[]"),1)):y("",!0)])]),_:1}),G,l(m,{h2:""},{default:t(()=>[e("Checklists")]),_:1}),l(r,null,{pug:t(()=>[e(`w-flex(wrap basis-zero :gap="3")
  .grow
    .title3.mb4 Default
    w-list(
      v-model="selection1"
...
`)]),default:t(()=>[l(w,{wrap:"","basis-zero":"",gap:3},{default:t(()=>[i("div",H,[J,l(c,{modelValue:s.selection3,"onUpdate:modelValue":a[4]||(a[4]=o=>s.selection3=o),items:s.listItems1,checklist:"",color:"green"},null,8,["modelValue","items"])]),i("div",Q,[X,l(c,{modelValue:s.selection4,"onUpdate:modelValue":a[5]||(a[5]=o=>s.selection4=o),items:s.listItems1,checklist:"","round-checkboxes":"",color:"green"},null,8,["modelValue","items"])])]),_:1}),l(w,{class:"mt4",wrap:"","basis-zero":"",gap:3},{default:t(()=>[i("div",Z,[ee,l(c,{modelValue:s.selection6,"onUpdate:modelValue":a[6]||(a[6]=o=>s.selection6=o),items:s.listItems2,"item-value-key":"id",checklist:"",color:"primary"},{item:t(({item:o})=>[i("span",null,n(o.label),1),te,l(b,{md:""},{default:t(()=>[e(n(o.icon),1)]),_:2},1024)]),_:1},8,["modelValue","items"])]),i("div",le,[ie,l(c,{class:"custom",modelValue:s.selection7,"onUpdate:modelValue":a[7]||(a[7]=o=>s.selection7=o),items:s.listItems2,"item-value-key":"id",checklist:"",color:"primary"},{item:t(({item:o})=>[i("span",null,n(o.label),1),se,l(b,{md:""},{default:t(()=>[e(n(o.icon),1)]),_:2},1024)]),_:1},8,["modelValue","items"])])]),_:1})]),_:1}),l(m,{h3:""},{default:t(()=>[e("Checklist colors")]),_:1}),ne,l(r,null,{pug:t(()=>[e('w-list(v-model="selection5" :items="items" checklist)')]),html:t(()=>[e(`<w-list
  v-model="selection"
  :items="items"
  checklist>
</w-list>`)]),js:t(()=>[e(`data: () => ({
...
`)]),default:t(()=>[l(c,{modelValue:s.selection5,"onUpdate:modelValue":a[8]||(a[8]=o=>s.selection5=o),items:s.listItems5,checklist:""},null,8,["modelValue","items"])]),_:1}),l(m,{h2:""},{default:t(()=>[e("Navigation lists")]),_:1}),oe,ae,l(r,null,{pug:t(()=>[e(`w-list(:items="items" nav color="primary")
  template(#item="{ item }")
    span `+n("{{ item.label }")+`
    .spacer
