import{r as d,o as u,g as p,a as l,w as t,b as e,d as i,t as n,f as _,h as V,_ as v,W as I}from"./index-BW-0fVWL.js";const j={class:"lists-demo"},A=i("p",null,[e("The "),i("span",{class:"code"},"w-list"),e(" component has multiple uses:")],-1),S={class:"w-flex wrap"},T={class:"grow"},$=i("div",{class:"title3"},"Most basic",-1),E={class:"grow"},W=i("div",{class:"title3"},"With icons",-1),D=i("p",null,[e("Like in most components, you can set a "),i("code",null,"color"),e(" for the text and a "),i("code",null,"bg-color"),e(` for the
background.`)],-1),U=i("br",null,null,-1),N=V(`<p class="grey-light1">In addition to the hover effect, the items may also be selectable (as per the
...
<code>selection-color</code> to a falsy value (false, null, or empty string), or another color.</p>`,3),P=i("p",null,[e("In this example, we don't use the component's data at all."),i("br"),e(`
You can easily define items directly in the template and have a different custom layout for every
list item just like in this example.`)],-1),z=i("strong",null,"This is the great item #3",-1),K=i("p",null,[e("It's up to you to define your your list contents in the component's data or directly in the template."),i("br"),e(`
In this example each item has a different icon stored in the data object.`)],-1),M={class:"w-flex align-center justify-space-between"},O=i("p",null,[e("If you provide a "),i("code",null,"v-model"),e(" or a "),i("code",null,"model-value"),e(", the list items become selectable.")],-1),R={key:0},B=i("div",{class:"title3"},[e("clicked item ("),i("span",{class:"code"},"item-click"),e(" event):")],-1),L=i("br",null,null,-1),Y={class:"code"},q={class:"title3 mt2"},F={key:0,class:"ml2"},G={key:1,class:"ml2"},H=i("p",null,[e("Note: you can get the list selection from the v-model, or by listening to the "),i("span",{class:"code"},"input"),e(" event.")],-1),J={class:"grow"},Q=i("div",{class:"title3 mb4"},"Default",-1),X={class:"grow"},Z=i("div",{class:"title3 mb4"},"Round checkboxes",-1),ee={class:"grow"},te=i("div",{class:"title3 mb4"},"Custom rendering, default styles",-1),le=i("div",{class:"spacer"},null,-1),ie={class:"grow"},se=i("div",{class:"title3 mb4"},"Custom rendering & styles",-1),ne=i("div",{class:"spacer"},null,-1),oe=i("p",null,"A checklist can have all the color options that the normal list can have, even a different color per item.",-1),ae=i("p",null,[e("The navigation list expects a "),i("code",null,"route"),e(" attribute in the items that are links."),i("br"),e(`
If you are using Vue Router, all the links will automatically be `),i("strong",{class:"code"},"router-link"),e("s."),i("br")],-1),ce=i("p",null,[e("It is possible to disable a link with a "),i("code",null,"disabled: true"),e(" attribute in the item.")],-1),me=i("div",{class:"spacer"},null,-1);function re(s,a,f,g,k,h){const c=d("w-list"),m=d("title-link"),r=d("example"),b=d("w-icon"),C=d("w-radios"),w=d("w-flex"),x=d("router-view");return u(),p("div",j,[A,l(c,{items:4,icon:"wi-check"},{"item.1":t(()=>[e("Simple list with or without icons")]),"item.2":t(()=>[e("Checklists")]),"item.3":t(()=>[e("Navigation menus")]),"item.4":t(()=>[e("List of selectable items")]),_:1}),l(m,{h2:""},{default:t(()=>[e("Basic lists")]),_:1}),l(r,null,{pug:t(()=>[e(`.w-flex.wrap
  .grow
    .title3 Most basic
    w-list(:items="items")
  .grow
...
`)]),default:t(()=>[i("div",S,[i("div",T,[$,l(c,{items:s.listItems1},null,8,["items"])]),i("div",E,[W,l(c,{items:s.listItems1,icon:"wi-check"},null,8,["items"])])])]),_:1}),l(m,{h2:""},{default:t(()=>[e("Color & hoverable")]),_:1}),D,l(r,null,{pug:t(()=>[e(`w-list(:items="items" color="pink" hover)
br
...
`)]),default:t(()=>[l(c,{items:s.listItems4,color:"pink",hover:""},null,8,["items"]),U,l(c,{items:s.listItems4,"bg-color":"blue-light5",color:"primary",hover:""},null,8,["items"])]),_:1}),l(m,{h3:""},{default:t(()=>[e("Different color per item")]),_:1}),l(r,null,{pug:t(()=>[e('w-list(:items="items" hover)')]),html:t(()=>[e('<w-list :items="items" hover></w-list>')]),js:t(()=>[e(`data: () => ({
  items: [
...
`)]),default:t(()=>[l(c,{items:s.listItems5,hover:""},null,8,["items"])]),_:1}),l(m,{h3:""},{default:t(()=>[e("Selection-only color")]),_:1}),N,l(r,null,{pug:t(()=>[e(`w-list(
  :model-value="['Item 2']"
  :items="items"
...
`)]),default:t(()=>[l(c,{"model-value":["Item 2"],items:s.listItems4,"selection-color":"pink",multiple:""},null,8,["items"])]),_:1}),l(m,{h2:""},{default:t(()=>[e("Custom rendering")]),_:1}),P,l(r,null,{pug:t(()=>[e(`w-list(:items="5" hover)
  template(#item="{ index }")
    | Item `+n("{{ index }}")+`
  template(#item.3)
...
`)]),default:t(()=>[l(c,{items:5,hover:""},{item:t(({index:o})=>[e("Item "+n(o),1)]),"item.3":t(()=>[z]),_:1})]),_:1}),K,l(r,null,{pug:t(()=>[e(`w-list(:items="items" hover)
  template(#item="{ item }")
...
`)]),default:t(()=>[l(c,{items:s.listItems2,hover:""},{item:t(({item:o,index:y})=>[i("div",M,[e(n(o.label),1),l(b,{md:"",onClick:()=>s.listItems2.splice(y-1,1)},{default:t(()=>[e(n(o.icon),1)]),_:2},1032,["onClick"])])]),_:1},8,["items"])]),_:1}),l(m,{h2:""},{default:t(()=>[e("Selectable list items")]),_:1}),O,l(r,null,{pug:t(()=>[e(`w-radios.mb6(v-model="multiple" :items="radios" inline)
...
<div class="title3 mt2">
  ...
  selection: 2,
  itemClicked: null
})`)]),default:t(()=>[l(C,{class:"mb6",modelValue:s.multiple,"onUpdate:modelValue":a[0]||(a[0]=o=>s.multiple=o),items:s.radios,inline:""},null,8,["modelValue","items"]),l(w,{wrap:"","align-center":""},{default:t(()=>[l(c,{class:"grow mr4",modelValue:s.selection1,"onUpdate:modelValue":a[1]||(a[1]=o=>s.selection1=o),items:s.listItems1,color:"deep-purple",multiple:s.multiple,onItemClick:a[2]||(a[2]=o=>s.itemClicked=o)},null,8,["modelValue","items","multiple"]),s.itemClicked?(u(),p("div",R,[B,L,i("span",Y,n(s.itemClicked),1)])):_("",!0)]),_:1}),i("div",q,[e("Selected item:"),!s.multiple||Array.isArray(s.selection1)?(u(),p("code",F,n(s.selection1||"null"),1)):s.multiple?(u(),p("code",G,n(s.selection1?[s.selection1]:"[]"),1)):_("",!0)])]),_:1}),H,l(m,{h2:""},{default:t(()=>[e("Checklists")]),_:1}),l(r,null,{pug:t(()=>[e(`w-flex(wrap basis-zero :gap="3")
  .grow
    .title3.mb4 Default
    w-list(
      v-model="selection1"
...
`)]),default:t(()=>[l(w,{wrap:"","basis-zero":"",gap:3},{default:t(()=>[i("div",J,[Q,l(c,{modelValue:s.selection3,"onUpdate:modelValue":a[3]||(a[3]=o=>s.selection3=o),items:s.listItems1,checklist:"",color:"green"},null,8,["modelValue","items"])]),i("div",X,[Z,l(c,{modelValue:s.selection4,"onUpdate:modelValue":a[4]||(a[4]=o=>s.selection4=o),items:s.listItems1,checklist:"","round-checkboxes":"",color:"green"},null,8,["modelValue","items"])])]),_:1}),l(w,{class:"mt4",wrap:"","basis-zero":"",gap:3},{default:t(()=>[i("div",ee,[te,l(c,{modelValue:s.selection6,"onUpdate:modelValue":a[5]||(a[5]=o=>s.selection6=o),items:s.listItems2,"item-value-key":"id",checklist:"",color:"primary"},{item:t(({item:o})=>[i("span",null,n(o.label),1),le,l(b,{md:""},{default:t(()=>[e(n(o.icon),1)]),_:2},1024)]),_:1},8,["modelValue","items"])]),i("div",ie,[se,l(c,{class:"custom",modelValue:s.selection7,"onUpdate:modelValue":a[6]||(a[6]=o=>s.selection7=o),items:s.listItems2,"item-value-key":"id",checklist:"",color:"primary"},{item:t(({item:o})=>[i("span",null,n(o.label),1),ne,l(b,{md:""},{default:t(()=>[e(n(o.icon),1)]),_:2},1024)]),_:1},8,["modelValue","items"])])]),_:1})]),_:1}),l(m,{h3:""},{default:t(()=>[e("Checklist colors")]),_:1}),oe,l(r,null,{pug:t(()=>[e('w-list(v-model="selection5" :items="items" checklist)')]),html:t(()=>[e(`<w-list
  v-model="selection"
  :items="items"
  checklist>
</w-list>`)]),js:t(()=>[e(`data: () => ({
...
`)]),default:t(()=>[l(c,{modelValue:s.selection5,"onUpdate:modelValue":a[7]||(a[7]=o=>s.selection5=o),items:s.listItems5,checklist:""},null,8,["modelValue","items"])]),_:1}),l(m,{h2:""},{default:t(()=>[e("Navigation lists")]),_:1}),ae,ce,l(r,null,{pug:t(()=>[e(`w-list(:items="items" nav color="primary")
  template(#item="{ item }")
    span `+n("{{ item.label }")+`
    .spacer
